...
parser.add_argument('--search-input-file', required=False, default='../../data/extracted/trainset/cmrc_drcd.train.json')
parser.add_argument('--seed', required=False, type=int, default=42)
args = parser.parse_args()
random.seed(args.seed)

TRAINSET_NAME = 'train-cmrc-drcd.data'
...
if __name__ == "__main__":
    ...
    # 生成训练数据， train.data
    examples = read_squad_examples(search_input_file=args.search_input_file)
