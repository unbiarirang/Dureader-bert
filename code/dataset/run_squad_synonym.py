...
parser.add_argument('--search-input-file', required=False, default='../../data/extracted/trainset/search-synonym.train.json')
parser.add_argument('--zhidao-input-file', required=False, default='../../data/extracted/trainset/zhidao-synonym.train.json')
parser.add_argument('--seed', required=False, type=int, default=42)
args = parser.parse_args()
random.seed(args.seed)

TRAINSET_NAME = 'train-synonym.data'
DEVSET_NAME = 'dev-synonym.data'
...
def read_squad_examples(zhidao_input_file, search_input_file, is_training=True):
    ...
    with open(search_input_file, 'r', encoding='utf-8') as f:
        for line in tqdm(f.readlines()):
            ...
            # this condition do not meet because of synonym substitution
