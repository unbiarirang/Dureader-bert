...
parser.add_argument('--dev-zhidao_input_file', required=False, default='../../data/extracted/devset/zhidao-no-most-related.dev.json')
parser.add_argument('--seed', required=False, type=int, default=42)
args = parser.parse_args()
random.seed(args.seed)

TRAINSET_NAME = 'train' + str(args.max_seq_length) + '-no-most-related.data'
DEVSET_NAME = 'dev' + str(args.max_seq_length) + '-no-most-related.data'
