...
#
    ...
    cat $SOURCE_DIR/devset/search-no-most-related.dev.json | python paragraph_extraction_recall.py dev \
            > $TARGET_DIR/devset/search-recall.dev.json
    cat $SOURCE_DIR/devset/zhidao-no-most-related.dev.json | python paragraph_extraction_recall.py dev \
            > $TARGET_DIR/devset/zhidao-recall.dev.json
