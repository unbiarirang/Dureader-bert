...
#
    ...
    cat $SOURCE_DIR/devset/search-no-most-related.dev.json | python paragraph_extraction_f1.py test \
            > $TARGET_DIR/devset/search-f1.dev.json
    cat $SOURCE_DIR/devset/zhidao-no-most-related.dev.json | python paragraph_extraction_f1.py test \
            > $TARGET_DIR/devset/zhidao-f1.dev.json
